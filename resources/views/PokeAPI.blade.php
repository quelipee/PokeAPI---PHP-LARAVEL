    ...
    <div class="px-6 pt-6 lg:px-8">
        <nav class="flex items-center justify-between" aria-label="Global">
            ...
            <div class="hidden lg:flex lg:gap-x-12">
                <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Pokemons</a>
        ...
        <div class="relative px-6 lg:px-8">
            <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                ...
                <div class="text-center">
                    <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">PokeGather</h1>
                    <p class="mt-6 text-lg leading-8 text-gray-600">PokeGather é uma plataforma online onde os fãs de Pokémon podem se cadastrar gratuitamente e começar a juntar o máximo de pokémons possível. Com uma interface simples e intuitiva</p>
